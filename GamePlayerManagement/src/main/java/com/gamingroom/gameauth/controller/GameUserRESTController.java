...
public class GameUserRESTController {
    ...
    // NB: Add RolesAllowed annotation for USER based on BasicAuth Security Example 
    //     If any other role besides "USER" tries to access this endpoint, they will
    //	   be met with a "not authorized" message.
    @RolesAllowed({ "USER" })
    @GET
    @Path("/{id}")
    ...
    // NB: Add RolesAllowed annotation for ADMIN based on BasicAuth Security Example 
    //     If any other role besides "ADMIN" tries to access this endpoint, they will
    //	   be met with a "not authorized" message.
    @RolesAllowed({ "ADMIN" })
    @POST
